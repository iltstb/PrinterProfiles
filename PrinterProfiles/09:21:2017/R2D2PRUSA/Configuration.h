...
#define CUSTOM_MENDEL_NAME "GW Carver"
...
#define THERMAL_RUNAWAY_PROTECTION_HYSTERESIS 14 // in degree Celsius
...
// The pullups are needed if you directly connect a mechanical endswitch between the signal and ground pins R2D@ True Z because of NPN sensor LN.
...
// For   Stepper Enable Pins (Active Low) use 0, Non Inverting (Active High) use 1
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000, 410.82973} // customized for MakerFarm i3v 10"
